            ...
            <p style={{fontSize:20, color:'rgb(3, 59, 119)', marginLeft:'10rem'}}>ADD</p>
                <form className='form'>
                    ...
                    <div style={{ display: 'flex' }}>
                        <input placeholder='Jhon Sefa' name='name' className='input' value={this.state.name} onChange={this.changernameHandler}
                        />
                    </div>
